...
(function() {
    'use strict';
    const global = await import('https://cdn.rawgit.org/universales.gitlab.io/rentabilidades-team/core/global.js');
    const modulo = await import('https://cdn.rawgit.org/universales.gitlab.io/rentabilidades-team/modulos/'+location.hostname+'.js');
